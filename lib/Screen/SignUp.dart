...
import 'package:eshop_multivendor/Model/SignUpModel.dart';
...
class _SignUpPageState extends State<SignUp> with TickerProviderStateMixin {
  ...
  Future<void> getRegisterUser() async {
    var headers = {
      'Cookie': 'ci_session=55fa893f33214d65a55fa84fde7ef144daaed735'
    };
    var request = http.MultipartRequest('POST', Uri.parse(baseUrl + 'register_user'));
    ...
    // request.files.add(await http.MultipartFile.fromPath('res_image[]', '/home/alphawizz/Desktop/1663827445-3.png'));
    // request.files.add(await http.MultipartFile.fromPath('res_image[]', '/home/alphawizz/Desktop/ac-service.jpg'));
    ...
    if (response.statusCode == 200) {
      ...
      final jsonResponse = SignUpModel.fromJson(json.decode(finalresult));
    ...
    //   if (!error) {
    //     setSnackbar(getTranslated(context, 'REGISTER_SUCCESS_MSG')!);
    //     print('ddd ${getdata['data']} and ${msg}');
