      ...
      try {
        if (isLoadingmore) {
          ...
          if (CUR_USERID != null) {
            ...
            print("get order apis ${getOrderApi}  and ${parameter}");
...
/*  returnable() {
  ...
  productItem(OrderItem orderItem, OrderModel model) {
    ...
    int one = 00;
    int two = 00;
  if(orderItem.estitmateTime == "" || orderItem.estitmateTime!.length == 1 || orderItem.estitmateTime == "00"){
     minut = one;
     second = two;
  }
  else{
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          orderItem.status == null || orderItem.status == "" ? SizedBox.shrink() : Container(
                            ...
                            child: orderItem.status == "shipped" ? Text("Served",style: TextStyle(color: Colors.white),): orderItem.status == "delivered" ? Text("Served",style: TextStyle(color: Colors.white),) : Text("${orderItem.status}",style: TextStyle(color: Colors.white),),
                          ),
