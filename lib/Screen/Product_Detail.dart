...
class StateItem extends State<ProductDetail> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    print(" 1 st value ${_oldSelVarient}");
  ...
  void _chooseVarient() {
    ...
    if (widget.model!.stockType == "0" || widget.model!.stockType == "1") {
      if (widget.model!.availability == "1") {
        ...
        print(" 2 st value ${_oldSelVarient}");
      } else {
        available = false;
        outOfStock = true;
      }
      ...
      outOfStock = false;
      _oldSelVarient = widget.model!.selVarient;
      print(" 3 st value ${_oldSelVarient}");
      ...
      if (widget
        ...
        outOfStock = false;
        _oldSelVarient = widget.model!.selVarient;
        print(" 4 st value ${_oldSelVarient}");
        setState(() {
                                        ...
                                        if (selectedId.length == sinId.length &&
                                          ...
                                          if (widget.model!.stockType == "0" ||
                                            ...
                                            if (widget.model!.availability ==
                                              ...
                                              print(" 5 st value ${_oldSelVarient}");
                                            } else {
                                              available = false;
                                              outOfStock = true;
                                            }
                                            ...
                                            outOfStock = false;
                                            _oldSelVarient = varSelected;
                                            print(" 6 st value ${_oldSelVarient}");
                                          } else if (widget.model!.stockType ==
                                              "2") {
                                            if (widget
                                                    .model!
                                              ...
                                              outOfStock = false;
                                              _oldSelVarient = varSelected;
                                              print(" 7 st value ${_oldSelVarient}");
                                            } else {
                                              available = false;
                                              outOfStock = true;
                                            }
  ...
  applyVarient() {
    ...
    if (mounted)
      setState(() {
        ...
        print("selected variant ${widget.model!.selVarient}");
      });
  }
